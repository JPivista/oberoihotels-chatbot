...
import { ExperienceData } from "@/utils/jaipur-data";
  ...
  return (
    <>
      <div className="container mx-auto mt-10">
        ...
        <p className="mt-2">
          Specially curated private dining, cultural experiences and relaxing
          spa treatments
        </p>
        <div className="flex justify-between items-center mt-2">
          <p>with an unmistakably Oberoi signature.</p>
